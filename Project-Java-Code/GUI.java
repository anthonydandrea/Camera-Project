...
public class GUI {
   ...
   private JPanel imagePanel2;
   	...
   	// Some methods need to be synchronized in the monitor:
   			// Calling update on the pictures
   			// Updating mode when a button is pressed
   ...
   private void prepareGUI(){
      ...
      imagePanel1 = new JPanel(new BorderLayout());
      imagePanel1.setPreferredSize(new Dimension(475,350));
      imagePanel2 = new JPanel(new BorderLayout());
      imagePanel2.setPreferredSize(new Dimension(475,350));
      
      // Get the image files and display them
      ImageIcon image1 = new ImageIcon("/Users/Sonja/Desktop/hallway.jpg");
      JLabel label1 = new JLabel("", image1, JLabel.CENTER);
      imagePanel1.add( label1, BorderLayout.CENTER );
      
      ImageIcon image2 = new ImageIcon("/Users/Sonja/Desktop/hallway2.jpg");
   ...
   private class ButtonClickListener implements ActionListener{
      public void actionPerformed(ActionEvent e) {
         ...
         if( command.equals( "SYNCH" ))  {
            ...
            //monitor.changeMode(0);
         } else if( command.equals( "AUTO" ) )  {
            statusLabel.setText("Current Mode: Automatic"); 
            // Call monitor here to change mode
            //monitor.changeMode(2);
         } else {
            statusLabel.setText("Current Mode: Asynchronized");
            // Call monitor here to change mode
            //monitor.changeMode(1);
         }  	
      }		
   }
}
